...
var Ng4TwitterTimelineComponent = (function () {
    ...
    Ng4TwitterTimelineComponent.prototype.ngAfterViewInit = function () {
        ...
        function (twttr) {
            ...
            window['twttr'].widgets.createTimeline(_this.dataSrc, nativeElement, _this.opts).then(function success(embed) {
    ...
    ], Ng4TwitterTimelineComponent.prototype, "dataSrc", void 0);
    __decorate([
        Input(),
        __metadata("design:type", Object)
    ], Ng4TwitterTimelineComponent.prototype, "opts", void 0);
